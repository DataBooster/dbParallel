...
insert into XYZ.TPW_PUMP_CONFIG (ELEMENT_NAME, NUMBER_VALUE, DATE_VALUE, STRING_VALUE, DESCRIPTION_)
values ('LAST_ARCHIVED', null, to_date('03-04-2012 16:55:45', 'dd-mm-yyyy hh24:mi:ss'), '', 'The last time when archived all ended PJobs.');

insert into XYZ.TPW_PUMP_CONFIG (ELEMENT_NAME, NUMBER_VALUE, DATE_VALUE, STRING_VALUE, DESCRIPTION_)
values ('LAST_EXPIRED', null, to_date('03-04-2012 16:38:48', 'dd-mm-yyyy hh24:mi:ss'), '', 'The last time when expired all dead PJobs.');
...
insert into XYZ.TPW_PUMP_CONFIG (ELEMENT_NAME, NUMBER_VALUE, DATE_VALUE, STRING_VALUE, DESCRIPTION_)
values ('PRIMARY_BEAT', null, to_date('03-04-2012 16:56:15', 'dd-mm-yyyy hh24:mi:ss'), '', 'Heartbeat of Primary Pump Service.');

insert into XYZ.TPW_PUMP_CONFIG (ELEMENT_NAME, NUMBER_VALUE, DATE_VALUE, STRING_VALUE, DESCRIPTION_)
values ('PRIMARY_INTERVAL', 200, null, '', 'The Primary Pump Interval (Milliseconds).');

insert into XYZ.TPW_PUMP_CONFIG (ELEMENT_NAME, NUMBER_VALUE, DATE_VALUE, STRING_VALUE, DESCRIPTION_)
values ('STANDBY_BEAT', null, to_date('03-04-2012 16:55:45', 'dd-mm-yyyy hh24:mi:ss'), '', 'Heartbeat of Standby Pump Service.');
