...
AS
	...
	BEGIN
		...
		IF @@ROWCOUNT > 0
		BEGIN
			INSERT INTO TPW_PJOB_ARCHIVE (PJOB_ID, STATE_ID, TASK_ID_RECORD, SCHEDULED_TIME, EXPIRY_TIME, START_TIME, END_TIME, USER_APP, USER_NAME, DESCRIPTION_)
			...
			INSERT INTO TPW_TASK_ARCHIVE (PJOB_ID, TASK_ID, COMMAND_TIMEOUT, DYNAMIC_SQL_STMT, DESCRIPTION_, START_TIME, END_TIME, ERROR_MESSAGE)
